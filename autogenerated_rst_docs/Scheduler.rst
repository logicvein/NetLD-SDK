...
|                  |                | (read-only)     |
+------------------+----------------+-----------------+
| jobName          | String         | The name of the |
|                  |                | job             |
+------------------+----------------+-----------------+
| description      | String         | The description |
|                  |                | of the job      |
+------------------+----------------+-----------------+
| managedNetworks  | Array          | An array of     |
|                  |                | managed network |
|                  |                | names this job  |
|                  |                | set is          |
|                  |                | available in    |
+------------------+----------------+-----------------+
| jobType          | String         | One of the      |
|                  |                | pre-defined     |
|                  |                | NetLD job types |
|                  |                | (see below)     |
+------------------+----------------+-----------------+
| jobParameters    | Map            | A map (hash) of |
|                  |                | job parameter   |
|                  |                | name/value      |
|                  |                | pairs that are  |
|                  |                | specific to     |
...
|                  |                | (see below)     |
+------------------+----------------+-----------------+
| isAccessLimited  | Boolean        | ``true`` if the |
|                  |                | caller has      |
|                  |                | limited         |
|                  |                | visibility to   |
|                  |                | the networks    |
...
|                   |               | with            |
+-------------------+---------------+-----------------+
| executor          | String        | The user name   |
|                   |               | of the user who |
|                   |               | executed the    |
|                   |               | job             |
+-------------------+---------------+-----------------+
| startTime         | 64-bit        | The start time  |
|                   | Integer       | of the job as a |
|                   |               | Unix epoch      |
|                   |               | value           |
+-------------------+---------------+-----------------+
| endTime           | 64-bit        | The end time of |
|                   | Integer       | the job as a    |
|                   |               | Unix epoch      |
|                   |               | value           |
+-------------------+---------------+-----------------+
| completionState   | Integer       | 0=normal,       |
|                   |               | 1=cancelled,    |
|                   |               | 2=misfired      |
|                   |               | (schedule       |
|                   |               | missed)         |
...
|                   |               | "ABORT"         |
+-------------------+---------------+-----------------+
| isPartialView     | Boolean       | ``true`` if the |
|                   |               | caller has      |
|                   |               | limited         |
|                   |               | visibility to   |
|                   |               | the networks    |
...
+===================+=================+=======================+
| communityStrings  | String          | Additional SNMP       |
|                   |                 | community string or   |
|                   |                 | comma-separated list  |
|                   |                 | of strings            |
+-------------------+-----------------+-----------------------+
| boundaryNetworks  | String          | Comma-separated list  |
|                   |                 | of discovery boundary |
|                   |                 | networks (CIDR)       |
+-------------------+-----------------+-----------------------+
| crawl             | String          | A "boolean" value     |
|                   |                 | indicating whether    |
...
|                   |                 | devices               |
+-------------------+-----------------+-----------------------+
| includeInventory  | String          | A "boolean" value     |
|                   |                 | indicating whether    |
|                   |                 | the discovery should  |
...
|                   |                 | set to *"true"*       |
+-------------------+-----------------+-----------------------+
| addresses         | String          | A comma-separated     |
|                   |                 | list of IP address    |
|                   |                 | "shapes" to include   |
|                   |                 | in the discovery. See |
|                   |                 | below.                |
+-------------------+-----------------+-----------------------+
