...
See the `ZeroTouch Objects <#zerotouch-objects>`__ section for a description of the various objects consumed and returned by these APIs.

.. _zerotouchsearchhistory:
